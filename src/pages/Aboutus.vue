...
<template>
  ...
  <button type="button" @click="postSchedule" class="btn btn-info text-white">SAVE</button>
  <button type="button" @click="getSchedule" class="btn btn-info text-white">Get Comment</button>
...
export default {
  ...
  methods: {
    postSchedule() {
      ...
      //get innerhtml of table
      const tableHTML = document.getElementById("schedule").innerHTML;
      
      const functions = getFunctions(app);

      console.log(app);
      const postSchedule = httpsCallable(functions, 'postschedule');
      postSchedule({"schedule": { tableHTML } })
        .then((result) => {
          // Read result of the Cloud Function.
          /** @type {any} */
          console.log(result);
    ...
    getSchedule() {
      const functions = getFunctions(app);
      const getSchedule = httpsCallable(functions,
        'getschedule');
